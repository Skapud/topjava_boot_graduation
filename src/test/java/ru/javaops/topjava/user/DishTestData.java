...
public class DishTestData {
    ...
    public static final List<Dish> RESTAURANT1_DISHES = List.of(dish5, dish4, dish3, dish2, dish1);
    ...
    public static final List<Dish> RESTAURANT2_DISHES = List.of(dish13, dish12, dish11, dish10, dish9, dish8, dish7, dish6);
    ...
    public static final List<Dish> RESTAURANT3_DISHES = List.of(dish17, dish16, dish15, dish14);
    ...
    public static final List<Dish> RESTAURANT4_DISHES = List.of(dish23, dish22, dish21, dish20, dish19, dish18);
    ...
    public static final List<Dish> RESTAURANT5_DISHES = List.of(dish29, dish28, dish27, dish26, dish25, dish24);

    public static final List<Dish> RESTAURANTS_DISHES = Stream.of(RESTAURANT5_DISHES, RESTAURANT4_DISHES, RESTAURANT3_DISHES, RESTAURANT2_DISHES, RESTAURANT1_DISHES).flatMap(List::stream).toList();

    public static final List<Dish> TODAY_DISHES = List.of(dish29, dish28, dish27, dish15, dish14, dish11, dish10, dish4, dish3, dish2);
